...
classes = ('alligator crack', "arrow","block crack" ,"damaged base crack" ,"localise surface defect"  , \
           "multi crack","parallel lines","peel off with cracks","peeling off premix","pothole with crack" ,"rigid pavement crack",\
         "single crack" , "transverse crack"  ,  "wearing course peeling off", "white lane", "yellow lane")
